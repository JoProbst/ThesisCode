...
def get_args():
    ...
    *.example.com
    ...
    parser.add_argument('--target-domain-file', help='file containing all domains to retrieve links.')
    r = parser.parse_args()
...
def main():
    ...
    # with open('all_domains.csv', 'r') as f:
    with open(r.target_domain_file or 'all_domains.csv', 'r') as f:
        domains = [l.strip() for l in f.readlines()]

    collinfo = list(collinfo)
